/*------------------------------------------------------------------------------------------------------/
| Program: FIN00_OaklandInvoiceV1.0.js  Trigger: Batch    
| Client: Oakland   Request # SR5059
| 
| Version 1.0 - Base Version. 3/1/13 KG
| 1.1 - 5/28/14 DQ - Updated to filter invoices based on date & level for set processing.  
...
aa.env.setValue("setName","ENFORCEMENT_INVOICES");				//   Prefix for set ID
...
function mainProcess()
	...
	aa.sendMail("noreply@accela.com", emailAddress, "", batchJobName + " Job Statistics" ,  "Total unpaid invoices : " + invList.length + "<BR>" + 
												...
												"Invoice Level 1 Invoices Past 30 Days : " + invoiceLevel2 + "<BR>");
 	...
 	logMessage("INFO","Invoice Level 1 Invoices Past 30 Days : " + invoiceLevel2);
