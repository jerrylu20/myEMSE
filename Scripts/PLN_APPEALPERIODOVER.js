/*------------------------------------------------------------------------------------------------------/
| Oakland Planning Appeal Period Over Batch
|
| 11/20/2012 - KG
/------------------------------------------------------------------------------------------------------*/
...
function mainProcess()
	...
	for (thisCap in capTypeList) {  
			...
			*/
			...
			if(!matches(capStatus,"Revoked-Pending Appeal","Modified-Pending Appeal","Not Changed-Pending Appeal"))
			{
				capFilterStatus++;
			...
			if(appealEndDate != "undefined" && appealEndDate != null && appealEndDate != "")
			{
				...
				if (todayJS > appealEndDateJS)
				{
					...
					if(capStatus == "Revoked-Pending Appeal")
					{
						updateTask("Closure","Activity Revoked","Updated by Batch Script","");
						logMessage("Workflow Task Closure was updated to Activity Revoked on Record " + capIDshow);
						capWorkflowUpdated++;
					}
					
					if(capStatus == "Modified-Pending Appeal")
					{
						updateTask("Closure","Activity Modified","Updated by Batch Script","");
						logMessage("Workflow Task Closure was updated to Activity Modified on Record " + capIDshow);
						capWorkflowUpdated++;
					}
					
					if(capStatus == "Not Changed-Pending Appeal")
					{
						updateTask("Closure","Activity Not Changed","Updated by Batch Script","");
						logMessage("Workflow Task Closure was updated to Activity Not Changed on Record " + capIDshow);
						capWorkflowUpdated++;
					}
