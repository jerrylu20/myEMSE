/*------------------------------------------------------------------------------------------------------/
| Oakland Planning Appeal Period Over LM Batch
|
| 06/20/2013 - KG
/------------------------------------------------------------------------------------------------------*/
...
function mainProcess()
	...
	for (thisCap in capTypeList) {  
			...
			*/
			...
			if(!matches(capStatus,"Approved-Pending Appeal","Denied-Pending Appeal"))
			{
				capFilterStatus++;
			...
			if(appealEndDate != "undefined" && appealEndDate != null && appealEndDate != "")
			{
				...
				if (todayJS > appealEndDateJS)
				{
					...
					if(capStatus == "Approved-Pending Appeal")
					{
						updateTask("Closure","Heritage Property Approved","Updated by Batch Script","");
						logDebug("Workflow Task Closure was updated to Heritage Property Approved on Record " + capIDshow);
						capWorkflowUpdated++;
					}
					
					if(capStatus == "Denied-Pending Appeal")
					{
						updateTask("Closure","Heritage Property Denied","Updated by Batch Script","");
						logDebug("Workflow Task Closure was updated to Heritage Property Denied on Record " + capIDshow);
						capWorkflowUpdated++;
					}
