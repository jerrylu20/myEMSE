/*------------------------------------------------------------------------------------------------------/
| Program: FinanceInvoice2SetV1.0.js  Trigger: Batch    
| Client: Oakland   Request # 
| 
| Version 1.0 - Base Version. 3/1/13 JHS
/------------------------------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------/
|
...
function mainProcess()
	...
	for (thisInv in invList)  // for each Invoice
		...
		logDebug("CAP:" + capIDshow + " INV:" + thisInvoice.getInvNbr() + " BAL:$" + thisInvoice.getInvoiceModel().getBalanceDue() + " DATE:" + thisInvoice.invDate.getMonth() + "/" + thisInvoice.invDate.getDayOfMonth() + "/" + thisInvoice.invDate.getYear() + " LVL:" + invoiceLvl);		
		capCount++;
